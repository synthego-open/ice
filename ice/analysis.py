...
def multiple_sanger_analysis(definition_file, output_dir,
    ...
    for job in jobs:
        ...
        if r is not None:
            tmp = [experiment['Label'], r['ice'], r['ice_d'], r['rsq'], r['hdr_pct'],r['ko_score'], r['guides'],r['base'],r['predicted'],
    ...
    if results:
        ...
        header = ["sample_name", "ice", 'ice_d', "r_squared", "hdr_pct","ko_score", "guides","base","predicted", "notes",
